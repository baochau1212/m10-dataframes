...
combine.yards <- rushing.yards + passing.yards
# What is the score of the game where the Huskies had the most combined yards?
most.combine.yards <- husky.scores[combine.yards == max(combine.yards)]
